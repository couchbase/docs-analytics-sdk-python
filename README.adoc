...
https://docs.couchbase.com/python-analytics-sdk/1.0/hello-world/overview.html[Analytics Python SDK Documentation].


This branch documents the 1.0 release of the SDK.
It follows the https://docs.couchbase.com/python-analytics-sdk/1.0/project-docs/compatibility.html#api-version[SDK 1.0 API].
