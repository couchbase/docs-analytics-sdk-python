= Couchbase Analytics Python SDK Documentation

This repository hosts the documentation source for the
https://docs.couchbase.com/python-analytics-sdk/1.1/hello-world/overview.html[Analytics Python SDK Documentation].


This branch documents the 1.1 release of the SDK.
It follows the https://docs.couchbase.com/python-analytics-sdk/1.1/project-docs/compatibility.html#api-version[SDK 1.1 API].
...
| `name-sdk:` | Allows us to name the SDK within shared content (*Python Analytics SDK*).
