...
The examples in this first section of the page are for the standard API -- with blocking and async client-side APIs -- working with Enterprise Analytics 2.0 and later (with {async-server-api-feature-name} examples following in the <<#server-asynchronous-api,Server Async section>>).
