...
IMPORTANT: Only one logger can be created.  Either use `PYCBAC_LOG_LEVEL` to create a console logger or python `logging`, as mentioned above.

In the command line environment, the PYCBAC_LOG_LEVEL variable is set as follows:
