...
The simplest way to create a `Cluster` object is to call `Cluster.create_instance()` with a <<connection-strings, connection string>>, user credentials, and any optional settings:
