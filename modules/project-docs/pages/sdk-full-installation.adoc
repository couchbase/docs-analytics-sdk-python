...
A select set of wheels is available on the https://github.com/couchbase/analytics-python-client/releases[GitHub Releases page].
If a wheel is not available for your specific Python version and/or platform,
See the https://github.com/couchbase/analytics-python-client/blob/main/BUILDING.md[GitHub Building page] for details on how to build the SDK's binary.

=== Installing from a Downloaded Package

To install the SDK from a wheel on the https://github.com/couchbase/analytics-python-client/releases[GitHub Releases page]:
...
* Follow the steps on the https://github.com/couchbase/analytics-python-client/blob/main/BUILDING.md[GitHub Building page].
